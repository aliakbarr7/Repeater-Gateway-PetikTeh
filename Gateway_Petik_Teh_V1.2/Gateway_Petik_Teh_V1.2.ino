...
currentMillis = millis();
   currentsecs = currentMillis / 300; 
    if ((unsigned long)(currentsecs - previoussecs) >= interval){
       ...
       if (Secs == 1){
          String message = "RPTR1"; 
          sendMessage(message,MasterNode, Node_Repeater1);
        }

       if (Secs == 2){
          String message = "RPTR2"; 
          sendMessage(message,MasterNode, Node_Repeater2);
        }
       
       if (Secs == 3){
          String message = "RPTR3"; 
          sendMessage(message,MasterNode, Node_Repeater3);
          Secs = 0;
        }
